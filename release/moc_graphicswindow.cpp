...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GraphicsWindow_t, stringdata) + ofs \
...
const QMetaObject GraphicsWindow::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_GraphicsWindow.data,
      qt_meta_data_GraphicsWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GraphicsWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GraphicsWindow.stringdata))
